    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="assets/backend/api/userdata/logout.php" class="dropdown-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="dashboard.php" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Users Panel</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <!-- Users -->
                        <li class="nav-item">
                            <a href="assets/frontend/includes/asset-side/users.php" class="nav-link">
                        ...
                        <!-- Assets -->
                        <li class="nav-item">
                            <a href="assets/frontend/includes/asset-side/assets.php" class="nav-link">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="assets/frontend/includes/asset-side/assets.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <a href="assets/frontend/includes/asset-side/users.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-7 connectedSortable">
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer clearfix">
                                    <a href="assets/frontend/includes/asset-side/assets.php" class="btn btn-sm btn-info float-right">View All Assets</a>
                                </div>
                            </div>
                            <!-- /.card -->
                        </section>
                        ...
                        // Add Others category if there're more than 5 categories
                        if ($otherCount > 0) {
                            $categoryData[] = [
                                'name' => 'Others',
                                'count' => $otherCount,
                        ...
                        // text color class based on days remaining
                        ...
                        <section class="col-lg-5 connectedSortable">
                                ...
                                <div class="card-footer bg-light p-0">
                                    <ul class="nav nav-pills flex-column">
                                        <?php foreach ($categoryData as $data): ?>
                                            <li class="nav-item">
                                                <a href="assets/frontend/includes/asset-side/assets.php?kategori=<?= urlencode($data['name']) ?>" class="nav-link">
                            ...
                            <!-- Asset Maintenance Schedule Card -->
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <div class="list-group">
                                        <?php if (count($maintenanceItems) > 0): ?>
                                            ...
                                            ?>
                                                <a href="assets/frontend/includes/asset-side/assets.php?id=<?= $item['id'] ?>" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="d-flex w-100 justify-content-between">
                                                        <h5 class="mb-1"><?= htmlspecialchars($item['nama_asset']) ?></h5>
                                                        <small class="<?= $colorClass ?>"><?= $daysRemaining ?> days</small>
                                                    </div>
                                                    <p class="mb-1">Schedlued maintenance for <?= htmlspecialchars($item['kategori']) ?> asset.</p>
                                ...
                                <div class="card-footer text-center">
                                    <a href="assets/frontend/includes/asset-side/assets.php">View All Scheduled Maintenance</a>
                                </div>
                            </div>
                            <!-- /.card -->
                        </section>
